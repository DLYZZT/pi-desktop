...
This notice was reviewed against the Pi Agent Desktop v0.1.9 production dependency graph. The license links below
...
| `@earendil-works/pi-ai`                                        | 0.84.2                  | Unified model-provider API               | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-agent-core`                                | 0.84.2                  | Agent runtime                            | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-coding-agent`                              | 0.84.2                  | Coding Agent and extension runtime       | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-tui`                                       | 0.84.2                  | Pi runtime dependency                    | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-client`                                    | 0.84.2                  | Pi client protocol implementation        | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-protocol`                                  | 0.84.2                  | Pi protocol types                        | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
| `@earendil-works/pi-telemetry`                                 | 0.84.2                  | Pi runtime telemetry API                 | [MIT](https://github.com/earendil-works/pi/blob/v0.84.2/LICENSE)      | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.84.2); Copyright © 2025 Mario Zechner      |
...
| `@xterm/xterm` / `@xterm/addon-fit` / `@xterm/addon-web-links` | 6.0.0 / 0.11.0 / 0.12.0 | Embedded Pi terminal rendering and links | [MIT](https://github.com/xtermjs/xterm.js/blob/6.0.0/LICENSE)         | [xtermjs/xterm.js](https://github.com/xtermjs/xterm.js/tree/6.0.0); Copyright © xterm.js contributors       |
| `node-pty`                                                     | 1.1.0                   | Per-session pseudoterminals              | [MIT](https://github.com/microsoft/node-pty/blob/1.1.0/LICENSE)       | [microsoft/node-pty](https://github.com/microsoft/node-pty/tree/1.1.0); Copyright © Microsoft Corporation   |
