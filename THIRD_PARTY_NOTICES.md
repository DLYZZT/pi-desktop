...
| `@earendil-works/pi-ai`                | 0.87.1           | Unified model-provider API                | [MIT](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE)                                                                 | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.87.1); Copyright © 2025 Mario Zechner                 |
| `@earendil-works/pi-agent-core`        | 0.87.1           | Agent runtime                             | [MIT](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE)                                                                 | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.87.1); Copyright © 2025 Mario Zechner                 |
| `@earendil-works/pi-coding-agent`      | 0.87.1           | Coding Agent and extension runtime        | [MIT](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE)                                                                 | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.87.1); Copyright © 2025 Mario Zechner                 |
| `@earendil-works/pi-tui`               | 0.87.1           | Pi runtime dependency                     | [MIT](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE)                                                                 | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.87.1); Copyright © 2025 Mario Zechner                 |
| `@earendil-works/pi-telemetry`         | 0.87.1           | Pi runtime telemetry API                  | [MIT](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE)                                                                 | [earendil-works/pi](https://github.com/earendil-works/pi/tree/v0.87.1); Copyright © 2025 Mario Zechner                 |
...
## Pi 0.87.1 runtime dependencies

The 0.87.1 SDK includes `@earendil-works/chord` 0.87.1 under the
[Pi MIT license](https://github.com/earendil-works/pi/blob/v0.87.1/LICENSE).
...
[esbuild MIT license](https://github.com/evanw/esbuild/blob/v0.28.2/LICENSE.md).
The Desktop build tool remains separately pinned to esbuild 0.27.7.

| Component         | Version | License                                                                                  | Attribution / source                                                                                                          |
| ----------------- | ------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `grok-mermaid`    | 0.2.3   | [Apache-2.0](https://github.com/xl0/grok-mermaid/blob/v0.2.3/LICENSE)                    | [xl0/grok-mermaid](https://github.com/xl0/grok-mermaid/tree/v0.2.3); Copyright © 2023-2026 SpaceXAI and © 2026 Alexey Zaytsev |
| `typebox`         | 1.3.27  | [MIT](https://github.com/sinclairzx81/typebox/blob/main/license)                         | [sinclairzx81/typebox](https://github.com/sinclairzx81/typebox)                                                               |
